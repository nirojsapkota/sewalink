...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/niroj/projects/project_ideas/sewaLink/.claude
                  → checks /Users/niroj/projects/project_ideas/sewaLink/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/niroj/projects/project_ideas/sewaLink/.claude/get-shit-done
                  → writes to /Users/niroj/projects/project_ideas/sewaLink/.claude/get-shit-done/hooks/
...
@/Users/niroj/projects/project_ideas/sewaLink/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/niroj/projects/project_ideas/sewaLink/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/niroj/projects/project_ideas/sewaLink/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/niroj/projects/project_ideas/sewaLink/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/niroj/projects/project_ideas/sewaLink/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
