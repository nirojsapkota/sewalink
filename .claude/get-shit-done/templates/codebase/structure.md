...
- Usage: Reference from command with `@/Users/niroj/projects/project_ideas/sewaLink/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/niroj/projects/project_ideas/sewaLink/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/niroj/projects/project_ideas/sewaLink/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
