...
```bash
PHASE_INFO=$(node "/Users/niroj/projects/project_ideas/sewaLink/.gemini/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/niroj/projects/project_ideas/sewaLink/.gemini/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/niroj/projects/project_ideas/sewaLink/.gemini/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
