...
- **Global scope**: `/Users/niroj/projects/project_ideas/sewaLink/.kilo/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/niroj/projects/project_ideas/sewaLink/.kilo/notes/`)
...
2. Glob `/Users/niroj/projects/project_ideas/sewaLink/.kilo/notes/*.md` (if directory exists) — global notes
...
Global (/Users/niroj/projects/project_ideas/sewaLink/.kilo/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/niroj/projects/project_ideas/sewaLink/.kilo/notes/` — works in any directory
