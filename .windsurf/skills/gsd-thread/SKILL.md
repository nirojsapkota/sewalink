...
5. Commit:
   ```bash
   node "/Users/niroj/projects/project_ideas/sewaLink/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
