...
RSpec.describe 'Tasker viewing job details', type: :system do
  let(:poster) { User.create!(first_name: 'Poster', last_name: 'User', phone: '9800000001', active_role: :poster, onboarded: true, password: 'password', password_confirmation: 'password') }
  let(:tasker) { User.create!(first_name: 'Tasker', last_name: 'User', phone: '9800000002', active_role: :tasker, onboarded: true, password: 'password', password_confirmation: 'password') }
